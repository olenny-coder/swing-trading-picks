...
class TestSignalEngine(unittest.TestCase):
    ...
    def test_put_detected(self):
        _assert_any_hero_fires(self, HERO_PUT_MOD, SIGNAL_PUT)
    ...
    def test_put_levels_sane(self):
        ...
        self.assertTrue(checked, "expected at least one PUT signal")
